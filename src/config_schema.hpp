...
//
// Product-level configuration structs (LLM-specific) plus the top-level
// RanvierConfig that composes chassis and product configs.
//
// Infrastructure configs (ServerConfig, PoolConfig, ClusterConfig, etc.) are
// defined in chassis_config_schema.hpp and re-exported here for backward
// compatibility. Files that only need infrastructure configs can include
// chassis_config_schema.hpp directly.
//
...
// =============================================================================
// Routing Configuration (LLM-specific, stays in product layer)
// =============================================================================
...
// =============================================================================
// Assets Configuration (LLM-specific, stays in product layer)
// =============================================================================
...
// =============================================================================
// Top-Level Configuration (product-level, composes chassis + product configs)
// =============================================================================

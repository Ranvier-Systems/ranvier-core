...
| `invariant-audit-2026-07-03.md` | First invariant audit (semantic correctness, hot path): findings I-1…I-8; seeded `invariants.md`; 2026-07-04 verification note appended (all fixed, residual V-1) |
| `holistic-audit-2026-07-04.md` | Hard Rules / async-integrity audit of post-February churn (application, telemetry, config, gossip_protocol, http_controller delta): findings V1–V9 → BACKLOG §23 |

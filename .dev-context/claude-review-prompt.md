...
Run through each of the Hard Rules listed in claude-context.md. For each rule, provide one of:
...
Verify compliance with the list of Hard Rules outlined in claude-context.md
